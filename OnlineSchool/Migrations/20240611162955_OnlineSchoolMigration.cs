...
{
    /// <inheritdoc />
    public partial class OnlineSchoolMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubjectName = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    SubjectDescription = table.Column<string>(type: "nvarchar(1250)", maxLength: 1250, nullable: false),
